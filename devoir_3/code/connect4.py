...
def ai_random(arg_board, player):
    ...
    for col in nonfull_cols:
        ...
        if check_win(defense_board, col, abs(player - 3)):
    ...
    for i in range(6):
        ...
        for j in range(7):
            if board[i][j] == 1:
                print(
                    "🔴 ", end=""
                )  # Change the red dot with '1' or 'x' if your terminal does not support colours
            elif board[i][j] == 2:
                print(
                    "🔵 ", end=""
                )  # Change the blue dot with '2' or 'o' if your terminal does not support colours
            else:
                print("   ", end="")
        print("|")
    print("")
